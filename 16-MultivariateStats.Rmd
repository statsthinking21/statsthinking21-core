...
- When I am very happy, I can’t seem to stop myself from doing things that can have bad consequences. (Agree Strongly, Agree Some, Disagree Some, Disagree Strongly)
...
wm_variables <- c("spatial_span.forward_span", "spatial_span.reverse_span", "digit_span.forward_span","digit_span.reverse_span", "adaptive_n_back.mean_load")
