...
```{r echo=FALSE}
kable(curry_df, caption='Cumulative probability distribution for number of successful free throws by Steph Curry in 4 attempts.', digits=3)
```
