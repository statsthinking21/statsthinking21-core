install.packages("remotes")deps <- remotes::package_deps("rstan", dependencies = TRUE)deps <- deps[!deps$package == "shinystan", ]update(deps)if (!require("knitr")) install.packages("knitr",repos="https://cran.rstudio.com",dependencies=TRUE)
