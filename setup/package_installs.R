install.packages('rstan', repos='https://cloud.r-project.org/', dependencies=TRUE)if (!require("htmltools")) install.packages("htmltools",repos="https://cran.rstudio.com",dependencies=TRUE)
